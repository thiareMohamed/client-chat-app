...
const fetchMessages = async () => {
    const { data } = await useFetch<ChatMessage[]>('http://localhost:3002/chat/room/67aae819d5ce6c2301aa8866', {
        method: 'GET',
    });
...
<template>
    <div class="chat-container flex flex-col h-full p-4">
        <div class="">
            <div
        ...
        <div class="flex flex-col gap-2">
            <input type="text" v-model="senderId" class="h-10" />
            <input
                v-model="newMessage"
